'''
later this will create collection folders for data/cards/trainers pokemon tools ect...
the A1 A2 A4a type stuff

the point of collection folders is so im not opening a billion different files
'''
